...
from luban_meter.benchmark.inference.common.prompts import render_squad_prompt
from luban_meter.benchmark.inference.squad import benchmark, result
from luban_meter.benchmark.inference.squad.dataset import (
    convert_official,
    load_samples,
    validate_records,
)
from luban_meter.benchmark.inference.squad.scoring import (
    normalize_answer,
    parse_answer,
    score_answer,
)
...
class ScoringTests(unittest.TestCase):
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            subprocess.run(
                [
                    sys.executable,
                    "-m",
                    "luban_meter.benchmark.inference.scripts.prepare_squad",
                    "--source",
                    str(src),
                    "--out",
                    str(out),
    ...
    def test_parameters_and_registry(self):
        ...
        self.assertIn(
            "squad", BenchmarkRegistry().list_benchmarks("inference")
        )
    ...
    def test_http_chat_base_failures_and_recomputation(self):
        ...
        try:
            with tempfile.TemporaryDirectory() as directory:
                ...
                # Exercise the actual CLI, subprocess collector and reports.
