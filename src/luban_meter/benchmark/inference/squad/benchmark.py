"""Collect SQuAD 2.0 exact-match samples from an OpenAI-compatible service."""
...
from luban_meter.benchmark.inference.squad.dataset import load_samples
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="SQuAD 2.0 inference benchmark"
    )
